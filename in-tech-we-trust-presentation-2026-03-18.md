# In Tech We Trust — Slide Deck

## How to read this document

Each slide is separated by a horizontal rule (`---`).

- `##` headings are **section divider slides** — the major parts of the talk. Large centered text, minimal content.
- `###` headings are **subsection divider slides** — chapter headings within a section.
- `####` headings are **content slides** — the slide title is the heading text.

Blockquotes are actual on-slide quotes, displayed as quoted text with attribution.

**Image prompts** are given in HTML comments (`<!-- IMAGE: ... -->`). These describe the desired visual. The presenter may choose to use, adapt, or skip them.

**General style:** Dark background, light text. Minimal text per slide. Sans-serif. Quotes in italic. Section headings significantly larger than body text.
...
### A talk about technology, wisdom, and what we're not seeing

Rufus Pollock, Sylvie Barbier, and Rosie Bell

18 March 2026

<!-- IMAGE: Abstract image of a glowing circuit board pattern morphing into a cathedral stained-glass window. Conveys technology-as-religion theme. -->
...
<!-- IMAGE: Black-and-white photograph of the Trinity nuclear test, the mushroom cloud rising over the New Mexico desert, July 1945. -->
...
<!-- IMAGE: A futuristic carbon-capture facility rendered as a cathedral — gleaming pipes and towers reaching skyward, scientists in lab coats kneeling before it. Satirical tone. -->
...
<!-- IMAGE: A child's face illuminated by a phone screen in a dark room. The light casts an eerie, almost sacred glow. -->
...
<!-- IMAGE: Ink-brush style illustration of a figure on a galloping horse, the rider's hands in the air, not holding the reins. Minimalist, East Asian aesthetic. -->
...
- **Climate**: tech-fuelled destruction of the biosphere → bet on future tech that doesn't exist
- **Information**: social media → algorithmic disinformation → AI fact-checkers → deeper distortion

Each fix creates the next crisis.

<!-- IMAGE: Disney's Sorcerer's Apprentice scene — Mickey Mouse overwhelmed by multiplying brooms carrying water. Or: a figure frantically plugging leaks in a dam while new cracks appear with each patch. -->

---

#### The Zen Master Visits Google
...
<!-- IMAGE: A tech CEO on stage in a black turtleneck, arms spread wide, bathed in a single spotlight, audience gazing upward. Framed to echo a preacher at a pulpit. -->
...
- **Materialism** — reality reduced to what can be measured
- **The myth of progress** — more tech is always better; questioning it is naive
- **Rationalism** — we're rational agents making free choices (so no need for guardrails)
- **Individualism** — separate selves competing for advantage
- **Homo economicus** — the sovereign consumer knows best; any harm is an "externality"
...
<!-- IMAGE: An aerial view of a medieval fort under siege. Some defenders are slipping out a back gate while others hold the walls. The composition makes the collective action problem visible. -->
...
#### The Balinese Water Temples

<!-- IMAGE: Photograph of a Balinese water temple (Pura Tirta Empul or similar). Lush green rice terraces in the background, intricate stone temple in the foreground, water flowing through carved channels. -->
...
#### A Fuller Account of Human Nature
...
A future society that survives will restore technology as servant to what is most human, most relational, and most conducive to life.

<!-- IMAGE: A simple image of human hands — perhaps planting something, or held open. Warm light. No technology visible. -->
